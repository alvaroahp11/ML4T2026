...
def _bollinger_components(symbol, sd, ed, window=20, num_std_dev=2):
    ...
    # Recorta TODO al rango real [sd, ed] antes de devolver
    return {
...
def _stochastic_components(symbol, sd, ed, k_window=14, d_window=3, smooth_k=3):
    ...
    # Factor de ajuste (Q10 del FAQ): Adj Close / Close, aplicado a High y Low
    ...
    percent_k = percent_k_raw.rolling(window=smooth_k).mean()  # slow stochastic
